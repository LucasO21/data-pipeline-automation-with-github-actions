...
We will continue with the same example we used before - the hourly demand of electricity for balancing authority sub-region PGAE. As before, we will use the API dashboard to extract the GET request:
